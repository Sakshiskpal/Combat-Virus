...
public class signUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Indore", "Mumbai", "Bhopal", "Khandwa", "rewa", "itarsi" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        sessionfactory = DBConnection.getDBInfo();
        Session session =  sessionfactory.openSession();
        Transaction tx = session.beginTransaction();
        UserLogin user =new UserLogin(id,fNm,pass, contact,address,city,gender);
        session.save(user);
        tx.commit();
        session.close();
